// Vendored: glkapi.js (MIT). Wrapped as an ES module for the ST_IF extension.
// Source: ifvms.js / glkote-term ecosystem (curiousdannii). Do not edit by hand.
/* eslint-disable */
export function createGlk() {
  const module = { exports: {} };
  const exports = module.exports;
  let Glk, ch, content_box, fref, ix, lineobj, lx, split;
